...
class SharedObsDictRelabelingBuffer(ObsDictRelabelingBuffer):
    ...
    def get_snapshot(self):
        ...
        #     mp_array_info=self._mp_array_info,
        #     shared_size=self._shared_size
        # )
        # snapshot.update(
        #     shared_obs_info=cloudpickle.dumps(self._shared_obs_info),
        #     shared_next_obs_info=cloudpickle.dumps(self._shared_next_obs_info),
        #     mp_array_info=cloudpickle.dumps(self._mp_array_info),
        #     shared_size=self._shared_size,
        # )
    ...
    def load_from_snapshot(self, snapshot):
        ...
        # self._shared_next_obs_info = cloudpickle.loads(
        #     snapshot['shared_next_obs_info'])
        # self._mp_array_info = cloudpickle.loads(
        #     snapshot['mp_array_info'])
        # self._shared_size = snapshot['shared_size']
