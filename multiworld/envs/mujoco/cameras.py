...
def sawyer_xyz_reacher_noisy_camera_v0(camera):
    camera.lookat[0] = 0
    camera.lookat[1] = np.random.normal(0.85, 0.02)
    camera.lookat[2] = np.random.normal(0.3, 0.02)
    camera.distance = np.random.normal(0.4, 0.02)
    camera.elevation = -35
    camera.azimuth = np.random.normal(270, 1)
    camera.trackbodyid = -1
...
def sawyer_door_env_noisy_camera_v0(camera):
    camera.distance = np.random.normal(0.25, 0.02)
    camera.lookat[0] = np.random.normal(-.2, 0.02)
    camera.lookat[1] = np.random.normal(0.55, 0.02)
    camera.lookat[2] = np.random.normal(0.6, 0.02)
    camera.elevation = -60
    camera.azimuth = np.random.normal(360, 1)
    camera.trackbodyid = -1
...
def sawyer_init_noisy_camera_zoomed_in(camera):
    camera.trackbodyid = 0
    camera.distance = 1.0
    ...
    # 3rd person view
    cam_dist = np.random.normal(0.3, 0.02)
    rotation_angle = np.random.normal(270, 1)
    cam_pos = np.array([0, np.random.normal(0.85, 0.02), np.random.normal(0.2, 0.02), cam_dist, -45, rotation_angle])
