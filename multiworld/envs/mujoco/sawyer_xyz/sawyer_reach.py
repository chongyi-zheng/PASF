...
class SawyerReachXYZEnv(SawyerXYZEnv, MultitaskEnv):
    def __init__(
        ...
        SawyerXYZEnv.__init__(self, model_name=self.model_name(domain), **kwargs)
    ...
    def model_name(self, domain):
        return get_asset_full_path('sawyer_xyz/sawyer_reach/sawyer_reach_'+domain+'.xml')
    ...
    def get_diagnostics(self, paths, prefix='', discount=None):
        ...
        for stat_name in [
            ...
            statistics.update(create_stats_ordered_dict(  # hand_distance
                '%s%s' % (prefix, stat_name),
                stat,
                discount=discount,
                always_show_all_stats=True,
                ))
            statistics.update(create_stats_ordered_dict(  # Final hand_distance
