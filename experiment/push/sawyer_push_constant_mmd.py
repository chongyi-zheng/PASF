...
def setting(idx):
    ...
    path = osp.join(osp.dirname(mwmj.__file__),
                    "goals", "single_puck_push_goals.npy",)
    if idx == 1:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mmd', type=float, default=200.0)
    ...
    env, version = 'SawyerPushNIPSEasy', '-v0'
    env_ids = [
        # training envs
        # same backgrounds since only table texture (domains) can be seen
        ['SawyerPushNIPSEasyDomain0-v0', 'Background-0', 'id-00'],
        ['SawyerPushNIPSEasyDomain1-v0', 'Background-0', 'id-01'],
        ['SawyerPushNIPSEasyDomain5-v0', 'Background-0', 'id-02'],
        # evaluation envs
        ['SawyerPushNIPSEasyDomain2-v0', 'Background-0', 'id-03'],
        ['SawyerPushNIPSEasyDomain3-v0', 'Background-0', 'id-04'],
        ['SawyerPushNIPSEasyDomain6-v0', 'Background-0', 'id-05'],
        ['SawyerPushNIPSEasyDomain4-v0', 'Background-0', 'id-06'],
        ['SawyerPushNIPSEasyDomain7-v0', 'Background-0', 'id-07']
    ]
    ...
    n_seeds = 1
    mode = 'local'
    exp_prefix = algo + '-push-setting-' + str(args.setting) + args.exp_token + args.para_token
